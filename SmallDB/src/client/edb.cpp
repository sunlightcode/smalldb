...
void Edb::start(void)
{
   std::cout << "Welcome to the smalldb Storage Engine!" << std::endl;
   std::cout << "Please be careful operation!" << std::endl;//"The input Ctrl+c or quit to exit!"
   while(0==gQuit)
   {
      prompt();
   }
